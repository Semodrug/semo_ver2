...
class CaseRecognitionList extends StatelessWidget {
  ...
  String content = '케이스 인식 기능은 베타버전으로, 아래 목록에 해당하는 의약품 인식을 제공합니다. 지원 가능한 의약품들은 추후 더 업데이트 될 예정입니다.\n';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        children: [
          Text(content),
          Text(list, style: Theme.of(context).textTheme.bodyText2.copyWith(),),
