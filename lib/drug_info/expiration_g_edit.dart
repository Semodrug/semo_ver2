...
class ExpirationGEdit extends StatefulWidget {
  final String drugItemSeq;
  final String expirationString;

  const ExpirationGEdit({Key key, this.drugItemSeq, this.expirationString})
      : super(key: key);

  @override
  _ExpirationGEditState createState() => _ExpirationGEditState();
}

class _ExpirationGEditState extends State<ExpirationGEdit> {
              ...
              onPressed: () {
                DatePicker.showDatePicker(context,
                  ...
                  setState(() {
                    ...
                    // currentTime: widget.pickedDateTime,
                    locale: LocaleType.ko); // need currentTime setting?
              },
              child: Container(
                height: 48,
