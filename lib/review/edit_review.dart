...
//                                          effect = "bad";
//                                        });
//                                        await ReviewService(documentId: widget.review.documentId).updateEffect(
//                                            "bad");
//                                        print("@@@EFECT: " + effect);
//                                        print("***widget.review.effect: "+ widget.review.effect);
//                                      }
//                                  ),
//                                  Padding(padding: EdgeInsets.only(top: 10)),
//                                  Text("별로에요", style: widget.review.effect == "bad"?
...
//
//                                  Padding(padding: EdgeInsets.only(top: 10)),
//                                  Text("보통이에요", style: widget.review.effect == "soso"?
//                                  TextStyle(fontWeight: FontWeight.bold, color: Colors.black87) :
//                                  TextStyle(color:Colors.black87)),
//                                ],
//                              ),
...
//                                  ),
//                                  Padding(padding: EdgeInsets.only(top: 10)),
//                                  Text("좋아요", style: widget.review.effect == "good"?
//                                  TextStyle(fontWeight: FontWeight.bold, color: Colors.black87) :
//                                  TextStyle(color:Colors.black87)),
//                                ],
//                              ),
...
//                                  ),
//                                  Padding(padding: EdgeInsets.only(top: 10)),
//                                  Text("있어요", style: widget.review.sideEffect == "yes"?
//                                  TextStyle(fontWeight: FontWeight.bold, color: Colors.black87) :
//                                  TextStyle(color:Colors.black87)),
//                                ],
//                              ),
...
//                                  ),
//                                  Padding(padding: EdgeInsets.only(top: 10)),
//                                  Text("없어요", style: widget.review.sideEffect == "no"?
//                                  TextStyle(fontWeight: FontWeight.bold, color: Colors.black87) :
//                                  TextStyle(color:Colors.black87)),
//                                ],
//                              ),
...
//                            itemSize: 48,
//                            glow: false,
//                            initialRating: widget.review.starRating*1.0,
//                            minRating: 1,
//                            direction: Axis.horizontal,
//                            allowHalfRating: false,
//                            itemCount: 5,
